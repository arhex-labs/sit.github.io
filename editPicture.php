...
<body style="overflow-y: scroll;">
	...
	<div class="profile-container" style="width: 30%; min-height: 100px; left: 35%;">
		<form method="POST" action="" enctype="multipart/form-data">
			<input style="padding: 10px 16px; width: 25vw; background: #E8F0FE; border: 1px #CCD1DA solid; border-radius: 5px; margin-top: 10px;" type="file" name="image" placeholder="Date of Birth (NOV 09, 1998)"><br/>
			<input style="padding: 10px 16px; width: 25vw; background: #356CB4; border: 1px #356CB4 solid; border-radius: 5px; margin-top: 10px; color: #fff; font-weight: 700;" type="submit" name="changePicture" value="Update Profile Picture">
		</form>
